...
class AntEnvV4(mujoco_env.MujocoEnv, utils.EzPickle):  # modification here
    def __init__(self):
        ...
        if self.computecanada:
            filepath = home + "/scratch/openai/CustomGymEnvs/envs/ant/xml/AntEnv_v4_BrokenUnseveredLimb.xml"
        else:
            filepath = home + "/Documents/openai/CustomGymEnvs/envs/ant/xml/AntEnv_v4_BrokenUnseveredLimb.xml"

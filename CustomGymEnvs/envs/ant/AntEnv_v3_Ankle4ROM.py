...
class AntEnvV3(mujoco_env.MujocoEnv, utils.EzPickle):  # modification here
    def __init__(self):
        ...
        if self.computecanada:
            filepath = home + "/scratch/openai/CustomGymEnvs/envs/ant/xml/AntEnv_v3_Ankle4ROM.xml"
        else:
            filepath = home + "/Documents/openai/CustomGymEnvs/envs/ant/xml/AntEnv_v3_Ankle4ROM.xml"

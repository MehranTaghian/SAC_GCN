...
class AntEnvV2(mujoco_env.MujocoEnv, utils.EzPickle):  # modification here
    def __init__(self):
        ...
        if self.computecanada:
            filepath = home + "/scratch/openai/CustomGymEnvs/envs/ant/xml/AntEnv_v2_Hip4ROM.xml"
        else:
            filepath = home + "/Documents/openai/CustomGymEnvs/envs/ant/xml/AntEnv_v2_Hip4ROM.xml"

...
tmux new-session -d -s thigh-5 "CUDA_VISIBLE_DEVICES=0 python $MAIN_FILE --env-name Walker2d-v2 --exp-type thigh_joint --automatic_entropy_tuning True --num_episodes 10000 --start_steps 10000 -dsf 100 --cuda --seed 5"
tmux new-session -d -s thigh-6 "CUDA_VISIBLE_DEVICES=0 python $MAIN_FILE --env-name Walker2d-v2 --exp-type thigh_joint --automatic_entropy_tuning True --num_episodes 10000 --start_steps 10000 -dsf 100 --cuda --seed 6"
tmux new-session -d -s thigh-7 "CUDA_VISIBLE_DEVICES=0 python $MAIN_FILE --env-name Walker2d-v2 --exp-type thigh_joint --automatic_entropy_tuning True --num_episodes 10000 --start_steps 10000 -dsf 100 --cuda --seed 7"
tmux new-session -d -s thigh-8 "CUDA_VISIBLE_DEVICES=0 python $MAIN_FILE --env-name Walker2d-v2 --exp-type thigh_joint --automatic_entropy_tuning True --num_episodes 10000 --start_steps 10000 -dsf 100 --cuda --seed 8"
tmux new-session -d -s thigh-9 "CUDA_VISIBLE_DEVICES=0 python $MAIN_FILE --env-name Walker2d-v2 --exp-type thigh_joint --automatic_entropy_tuning True --num_episodes 10000 --start_steps 10000 -dsf 100 --cuda --seed 9"

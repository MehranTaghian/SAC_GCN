...
tmux new-session -d -s fetchreach-7 "CUDA_VISIBLE_DEVICES=1 python $MAIN_FILE --env-name FetchReach-v2 --exp-type graph --automatic_entropy_tuning True --num_episodes 30000 --start_steps 10000 -dsf 100 -ef 100 --cuda --seed 7"
tmux new-session -d -s fetchreach-8 "CUDA_VISIBLE_DEVICES=1 python $MAIN_FILE --env-name FetchReach-v2 --exp-type graph --automatic_entropy_tuning True --num_episodes 30000 --start_steps 10000 -dsf 100 -ef 100 --cuda --seed 8"

...
# root
tmux new-session -d -s hopper-root-0 "CUDA_VISIBLE_DEVICES=1 python $MAIN_FILE --env-name Hopper-v2 --exp-type root --automatic_entropy_tuning True --num_episodes 10000 --start_steps 10000 -dsf 100 --cuda --seed 0"
tmux new-session -d -s hopper-root-1 "CUDA_VISIBLE_DEVICES=1 python $MAIN_FILE --env-name Hopper-v2 --exp-type root --automatic_entropy_tuning True --num_episodes 10000 --start_steps 10000 -dsf 100 --cuda --seed 1"
tmux new-session -d -s hopper-root-2 "CUDA_VISIBLE_DEVICES=1 python $MAIN_FILE --env-name Hopper-v2 --exp-type root --automatic_entropy_tuning True --num_episodes 10000 --start_steps 10000 -dsf 100 --cuda --seed 2"
tmux new-session -d -s hopper-root-3 "CUDA_VISIBLE_DEVICES=1 python $MAIN_FILE --env-name Hopper-v2 --exp-type root --automatic_entropy_tuning True --num_episodes 10000 --start_steps 10000 -dsf 100 --cuda --seed 3"
tmux new-session -d -s hopper-root-4 "CUDA_VISIBLE_DEVICES=1 python $MAIN_FILE --env-name Hopper-v2 --exp-type root --automatic_entropy_tuning True --num_episodes 10000 --start_steps 10000 -dsf 100 --cuda --seed 4"
tmux new-session -d -s hopper-root-5 "CUDA_VISIBLE_DEVICES=1 python $MAIN_FILE --env-name Hopper-v2 --exp-type root --automatic_entropy_tuning True --num_episodes 10000 --start_steps 10000 -dsf 100 --cuda --seed 5"
tmux new-session -d -s hopper-root-6 "CUDA_VISIBLE_DEVICES=1 python $MAIN_FILE --env-name Hopper-v2 --exp-type root --automatic_entropy_tuning True --num_episodes 10000 --start_steps 10000 -dsf 100 --cuda --seed 6"
tmux new-session -d -s hopper-root-7 "CUDA_VISIBLE_DEVICES=1 python $MAIN_FILE --env-name Hopper-v2 --exp-type root --automatic_entropy_tuning True --num_episodes 10000 --start_steps 10000 -dsf 100 --cuda --seed 7"
tmux new-session -d -s hopper-root-8 "CUDA_VISIBLE_DEVICES=1 python $MAIN_FILE --env-name Hopper-v2 --exp-type root --automatic_entropy_tuning True --num_episodes 10000 --start_steps 10000 -dsf 100 --cuda --seed 8"
tmux new-session -d -s hopper-root-9 "CUDA_VISIBLE_DEVICES=1 python $MAIN_FILE --env-name Hopper-v2 --exp-type root --automatic_entropy_tuning True --num_episodes 10000 --start_steps 10000 -dsf 100 --cuda --seed 9"

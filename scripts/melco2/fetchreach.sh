...
tmux new-session -d -s elbowflex-8 "CUDA_VISIBLE_DEVICES=1 python $MAIN_FILE --env-name FetchReachDense-v1 --exp-type elbow_flex_joint --automatic_entropy_tuning True --num_episodes 20000 --start_steps 10000 -dsf 100 --cuda --seed 8"
tmux new-session -d -s elbowflex-9 "CUDA_VISIBLE_DEVICES=1 python $MAIN_FILE --env-name FetchReachDense-v1 --exp-type elbow_flex_joint --automatic_entropy_tuning True --num_episodes 20000 --start_steps 10000 -dsf 100 --cuda --seed 9"

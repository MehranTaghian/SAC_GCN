...
tmux new-session -d -s v0-2 "CUDA_VISIBLE_DEVICES=0 python $MAIN_FILE --env-name HalfCheetahEnv-v0 --exp-type standard --automatic_entropy_tuning True --num_steps 1000000 --start_steps 10000 -dsf 100 --cuda --seed 2"
...
tmux new-session -d -s v0-6 "CUDA_VISIBLE_DEVICES=3 python $MAIN_FILE --env-name HalfCheetahEnv-v0 --exp-type standard --automatic_entropy_tuning True --num_steps 1000000 --start_steps 10000 -dsf 100 --cuda --seed 6"
...
tmux new-session -d -s v0-8 "CUDA_VISIBLE_DEVICES=4 python $MAIN_FILE --env-name HalfCheetahEnv-v0 --exp-type standard --automatic_entropy_tuning True --num_steps 1000000 --start_steps 10000 -dsf 100 --cuda --seed 8"
tmux new-session -d -s v0-9 "CUDA_VISIBLE_DEVICES=4 python $MAIN_FILE --env-name HalfCheetahEnv-v0 --exp-type standard --automatic_entropy_tuning True --num_steps 1000000 --start_steps 10000 -dsf 100 --cuda --seed 9"

...
tmux new-session -d -s halfcheetah-root-2 "CUDA_VISIBLE_DEVICES=1 python $MAIN_FILE --env-name HalfCheetah-v2 --exp-type root --automatic_entropy_tuning True --num_episodes 10000 --start_steps 10000 -dsf 100 --cuda --seed 2"
tmux new-session -d -s halfcheetah-root-3 "CUDA_VISIBLE_DEVICES=1 python $MAIN_FILE --env-name HalfCheetah-v2 --exp-type root --automatic_entropy_tuning True --num_episodes 10000 --start_steps 10000 -dsf 100 --cuda --seed 3"
tmux new-session -d -s halfcheetah-root-4 "CUDA_VISIBLE_DEVICES=3 python $MAIN_FILE --env-name HalfCheetah-v2 --exp-type root --automatic_entropy_tuning True --num_episodes 10000 --start_steps 10000 -dsf 100 --cuda --seed 4"
tmux new-session -d -s halfcheetah-root-5 "CUDA_VISIBLE_DEVICES=3 python $MAIN_FILE --env-name HalfCheetah-v2 --exp-type root --automatic_entropy_tuning True --num_episodes 10000 --start_steps 10000 -dsf 100 --cuda --seed 5"
tmux new-session -d -s halfcheetah-root-6 "CUDA_VISIBLE_DEVICES=4 python $MAIN_FILE --env-name HalfCheetah-v2 --exp-type root --automatic_entropy_tuning True --num_episodes 10000 --start_steps 10000 -dsf 100 --cuda --seed 6"
tmux new-session -d -s halfcheetah-root-7 "CUDA_VISIBLE_DEVICES=4 python $MAIN_FILE --env-name HalfCheetah-v2 --exp-type root --automatic_entropy_tuning True --num_episodes 10000 --start_steps 10000 -dsf 100 --cuda --seed 7"
tmux new-session -d -s halfcheetah-root-8 "CUDA_VISIBLE_DEVICES=6 python $MAIN_FILE --env-name HalfCheetah-v2 --exp-type root --automatic_entropy_tuning True --num_episodes 10000 --start_steps 10000 -dsf 100 --cuda --seed 8"
tmux new-session -d -s halfcheetah-root-9 "CUDA_VISIBLE_DEVICES=6 python $MAIN_FILE --env-name HalfCheetah-v2 --exp-type root --automatic_entropy_tuning True --num_episodes 10000 --start_steps 10000 -dsf 100 --cuda --seed 9"

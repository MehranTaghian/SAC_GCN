MAIN_FILE="~/Documents/SAC_GCN/Controller/graph/main.py"
#MAIN_FILE="~/Documents/SAC_GCN/Controller/basic/main.py"

CUDA_VISIBLE_DEVICES=0 python $MAIN_FILE --env-name FetchReachEnv-v0 --exp-type test --automatic_entropy_tuning True --num_steps 300000 --start_steps 5000 -dsf 100 --cuda --seed 0

...
CUDA_VISIBLE_DEVICES=0 python $MAIN_FILE --env-name AntEnvGraph-v0 --exp-type bidirectional --automatic_entropy_tuning True --num_steps 10000000 --start_steps  10000 -dsf 10 --cuda --seed 0

CUDA_VISIBLE_DEVICES=0 python $MAIN_FILE --env-name HalfCheetahEnvGraph-v0 --automatic_entropy_tuning True --num_steps 2000000 --start_steps  10000 -dsf 10 --cuda --seed 0

...
CUDA_VISIBLE_DEVICES=0 python main.py --env-name HalfCheetahEnv-v0 --automatic_entropy_tuning True --num_steps 10000000 --start_steps  20000 -dsf 10 --cuda --seed 0

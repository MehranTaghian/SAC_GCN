...
CUDA_VISIBLE_DEVICES=0 python $MAIN_FILE --env-name HalfCheetahEnvGraph-v0 --automatic_entropy_tuning True --num_episodes 10000 --start_steps 10000 -dsf 10 --cuda --seed 0

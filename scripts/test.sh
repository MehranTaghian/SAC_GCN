...
CUDA_VISIBLE_DEVICES=0 python main.py --env-name FetchReachEnv-v5 --exp-type test --automatic_entropy_tuning True --num_steps 2000000 --start_steps 10000 -dsf 100 --cuda --seed 0

CUDA_VISIBLE_DEVICES=0 python main.py --env-name FetchPickAndPlaceEnv-v0 --exp-type test --automatic_entropy_tuning True --num_steps 1000000 --start_steps 5000 -dsf 100 --cuda --seed 0

...
CUDA_VISIBLE_DEVICES=0 python $MAIN_FILE --env-name FetchReachEnv-v0 --exp-type test --automatic_entropy_tuning True --num_steps 300000 --start_steps 10000 -dsf 100 --cuda --seed 0

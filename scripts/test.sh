...
CUDA_VISIBLE_DEVICES=3 python $MAIN_FILE --env-name AntEnvGraph-v0 --exp-type test --automatic_entropy_tuning True --num_steps 10000000 --start_steps  10000 -dsf 10 --cuda --seed 0
